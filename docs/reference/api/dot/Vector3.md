...
!!! warning "Under Construction"
    ...
    [https://github.com/phetsims/dot/blob/main/js/Vector3.ts](https://github.com/phetsims/dot/blob/main/js/Vector3.ts) for the most up-to-date information.
...
#### new Vector3( x : <span style="font-weight: 400;"><span style="color: hsla(calc(var(--md-hue) + 180deg),80%,40%,1);">number</span></span>, y : <span style="font-weight: 400;"><span style="color: hsla(calc(var(--md-hue) + 180deg),80%,40%,1);">number</span></span>, z : <span style="font-weight: 400;"><span style="color: hsla(calc(var(--md-hue) + 180deg),80%,40%,1);">number</span></span> ) {: #Vector3-constructor data-toc-label='new Vector3' }
