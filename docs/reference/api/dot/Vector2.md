...
#### new Vector2( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span> ) {: #constructor data-toc-label='constructor' }
...
#### distance( point : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">number</span> {: #distance data-toc-label='distance' }

The Euclidean distance between this vector (treated as a point) and another point.

#### distanceXY( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">number</span> {: #distanceXY data-toc-label='distanceXY' }

The Euclidean distance between this vector (treated as a point) and another point (x,y).

#### distanceSquared( point : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">number</span> {: #distanceSquared data-toc-label='distanceSquared' }

The squared Euclidean distance between this vector (treated as a point) and another point.

#### distanceSquaredXY( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">number</span> {: #distanceSquaredXY data-toc-label='distanceSquaredXY' }

The squared Euclidean distance between this vector (treated as a point) and another point with coordinates (x,y).

#### dot( v : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">number</span> {: #dot data-toc-label='dot' }

The dot-product (Euclidean inner product) between this vector and another vector v.

#### dotXY( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">number</span> {: #dotXY data-toc-label='dotXY' }

The dot-product (Euclidean inner product) between this vector and another vector (x,y).

#### getAngle() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getAngle data-toc-label='getAngle' }
...
#### angleBetween( v : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">number</span> {: #angleBetween data-toc-label='angleBetween' }
...
#### equals( other : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #equals data-toc-label='equals' }

Exact equality comparison between this vector and another vector.

@returns - Whether the two vectors have equal components

#### equalsEpsilon( other : <span style="font-weight: 400; opacity: 80%;">Vector2</span>, epsilon : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #equalsEpsilon data-toc-label='equalsEpsilon' }
...
#### copy( vector? : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #copy data-toc-label='copy' }
...
#### crossScalar( v : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">number</span> {: #crossScalar data-toc-label='crossScalar' }
...
#### normalized() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #normalized data-toc-label='normalized' }
...
#### roundedSymmetric() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #roundedSymmetric data-toc-label='roundedSymmetric' }
...
#### withMagnitude( magnitude : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #withMagnitude data-toc-label='withMagnitude' }
...
#### timesScalar( scalar : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #timesScalar data-toc-label='timesScalar' }
...
#### times( scalar : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #times data-toc-label='times' }
...
#### componentTimes( v : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #componentTimes data-toc-label='componentTimes' }
...
#### plus( v : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #plus data-toc-label='plus' }
...
#### plusXY( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #plusXY data-toc-label='plusXY' }
...
#### plusScalar( scalar : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #plusScalar data-toc-label='plusScalar' }
...
#### minus( v : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #minus data-toc-label='minus' }
...
#### minusXY( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #minusXY data-toc-label='minusXY' }
...
#### minusScalar( scalar : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #minusScalar data-toc-label='minusScalar' }
...
#### dividedScalar( scalar : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #dividedScalar data-toc-label='dividedScalar' }
...
#### negated() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #negated data-toc-label='negated' }
...
#### getPerpendicular() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #getPerpendicular data-toc-label='getPerpendicular' }

Rotated by -pi/2 (perpendicular to this vector), returned as a copy.

#### rotated( angle : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #rotated data-toc-label='rotated' }
...
#### rotateAboutXY( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span>, angle : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #rotateAboutXY data-toc-label='rotateAboutXY' }
...
#### rotateAboutPoint( point : <span style="font-weight: 400; opacity: 80%;">Vector2</span>, angle : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #rotateAboutPoint data-toc-label='rotateAboutPoint' }

Same as rotateAboutXY but with a point argument.

#### rotatedAboutXY( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span>, angle : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #rotatedAboutXY data-toc-label='rotatedAboutXY' }
...
#### rotatedAboutPoint( point : <span style="font-weight: 400; opacity: 80%;">Vector2</span>, angle : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #rotatedAboutPoint data-toc-label='rotatedAboutPoint' }

Immutable method that returns a new Vector2 rotated about the given point.

#### blend( vector : <span style="font-weight: 400; opacity: 80%;">Vector2</span>, ratio : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #blend data-toc-label='blend' }
...
#### average( vector : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #average data-toc-label='average' }
...
#### setXY( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #setXY data-toc-label='setXY' }

Sets all of the components of this vector, returning this.

#### setX( x : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #setX data-toc-label='setX' }

Sets the x-component of this vector, returning this.

#### setY( y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #setY data-toc-label='setY' }

Sets the y-component of this vector, returning this.

#### set( v : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #set data-toc-label='set' }
...
#### setMagnitude( magnitude : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #setMagnitude data-toc-label='setMagnitude' }
...
#### add( v : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #add data-toc-label='add' }
...
#### addXY( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #addXY data-toc-label='addXY' }
...
#### addScalar( scalar : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #addScalar data-toc-label='addScalar' }
...
#### subtract( v : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #subtract data-toc-label='subtract' }
...
#### subtractXY( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #subtractXY data-toc-label='subtractXY' }
...
#### subtractScalar( scalar : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #subtractScalar data-toc-label='subtractScalar' }
...
#### multiplyScalar( scalar : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #multiplyScalar data-toc-label='multiplyScalar' }
...
#### multiply( scalar : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #multiply data-toc-label='multiply' }
...
#### componentMultiply( v : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #componentMultiply data-toc-label='componentMultiply' }
...
#### divideScalar( scalar : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #divideScalar data-toc-label='divideScalar' }
...
#### negate() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #negate data-toc-label='negate' }
...
#### normalize() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #normalize data-toc-label='normalize' }
...
#### roundSymmetric() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #roundSymmetric data-toc-label='roundSymmetric' }
...
#### rotate( angle : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #rotate data-toc-label='rotate' }
...
#### setPolar( magnitude : <span style="font-weight: 400; opacity: 80%;">number</span>, angle : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #setPolar data-toc-label='setPolar' }
...
#### toStateObject() : <span style="font-weight: 400; opacity: 80%;">Vector2StateObject</span> {: #toStateObject data-toc-label='toStateObject' }
...
#### isVector2 : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #isVector2 data-toc-label='isVector2' }

#### dimension : <span style="font-weight: 400; opacity: 80%;">number</span> {: #dimension data-toc-label='dimension' }

### Static Methods

#### average( vectors : <span style="font-weight: 400; opacity: 80%;">Vector2[]</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #average data-toc-label='average' }

Take a component-based mean of all vectors provided.

#### createPolar( magnitude : <span style="font-weight: 400; opacity: 80%;">number</span>, angle : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #createPolar data-toc-label='createPolar' }
...
#### fromStateObject( stateObject : <span style="font-weight: 400; opacity: 80%;">Vector2StateObject</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #fromStateObject data-toc-label='fromStateObject' }
...
#### getAngleBetweenVectors( startVector : <span style="font-weight: 400; opacity: 80%;">Vector2</span>, endVector : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getAngleBetweenVectors data-toc-label='getAngleBetweenVectors' }

Allocation-free implementation that gets the angle between two vectors

@returns the angle between the vectors

#### getDistanceBetweenVectors( startVector : <span style="font-weight: 400; opacity: 80%;">Vector2</span>, endVector : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getDistanceBetweenVectors data-toc-label='getDistanceBetweenVectors' }
...
#### ZERO : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #ZERO data-toc-label='ZERO' }

ImmutableVector2 zero vector: $\begin{bmatrix} 0\\0 \end{bmatrix}$

#### X_UNIT : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #X_UNIT data-toc-label='X_UNIT' }

ImmutableVector2 vector: $\begin{bmatrix} 1\\0 \end{bmatrix}$

#### Y_UNIT : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #Y_UNIT data-toc-label='Y_UNIT' }

ImmutableVector2 vector: $\begin{bmatrix} 0\\1 \end{bmatrix}$

#### Vector2IO : <span style="font-weight: 400; opacity: 80%;">IOType</span> {: #Vector2IO data-toc-label='Vector2IO' }
