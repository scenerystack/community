...
#### new Bounds3( minX : <span style="font-weight: 400; opacity: 80%;">number</span>, minY : <span style="font-weight: 400; opacity: 80%;">number</span>, minZ : <span style="font-weight: 400; opacity: 80%;">number</span>, maxX : <span style="font-weight: 400; opacity: 80%;">number</span>, maxY : <span style="font-weight: 400; opacity: 80%;">number</span>, maxZ : <span style="font-weight: 400; opacity: 80%;">number</span> ) {: #constructor data-toc-label='constructor' }
...
#### getDepth() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getDepth data-toc-label='getDepth' }
...
#### getZ() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getZ data-toc-label='getZ' }
...
#### getMinZ() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getMinZ data-toc-label='getMinZ' }
...
#### getMaxZ() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getMaxZ data-toc-label='getMaxZ' }
...
#### getBack() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getBack data-toc-label='getBack' }
...
#### getFront() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getFront data-toc-label='getFront' }
...
#### getCenterZ() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getCenterZ data-toc-label='getCenterZ' }

The depthwise (Z-coordinate) center of the bounds, averaging the minZ and maxZ.

#### getCenter() : <span style="font-weight: 400; opacity: 80%;">Vector3</span> {: #getCenter data-toc-label='getCenter' }
...
#### hasNonzeroVolume() : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #hasNonzeroVolume data-toc-label='hasNonzeroVolume' }
...
#### containsCoordinates( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span>, z : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #containsCoordinates data-toc-label='containsCoordinates' }
...
#### containsPoint( point : <span style="font-weight: 400; opacity: 80%;">Vector3</span> ) : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #containsPoint data-toc-label='containsPoint' }

Whether the point is contained inside the bounding box, or is on the boundary.

#### containsBounds( bounds : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> ) : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #containsBounds data-toc-label='containsBounds' }

Whether this bounding box completely contains the bounding box passed as a parameter. The boundary of a box is
considered to be "contained".

#### intersectsBounds( bounds : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> ) : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #intersectsBounds data-toc-label='intersectsBounds' }
...
#### equals( other : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> ) : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #equals data-toc-label='equals' }

Exact equality comparison between this bounds and another bounds.

#### equalsEpsilon( other : <span style="font-weight: 400; opacity: 80%;">Bounds3</span>, epsilon : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #equalsEpsilon data-toc-label='equalsEpsilon' }
...
#### copy( bounds? : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #copy data-toc-label='copy' }
...
#### union( bounds : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #union data-toc-label='union' }
...
#### intersection( bounds : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #intersection data-toc-label='intersection' }
...
#### withCoordinates( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span>, z : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #withCoordinates data-toc-label='withCoordinates' }
...
#### withPoint( point : <span style="font-weight: 400; opacity: 80%;">Vector3</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #withPoint data-toc-label='withPoint' }
...
#### withMinX( minX : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #withMinX data-toc-label='withMinX' }
...
#### withMinY( minY : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #withMinY data-toc-label='withMinY' }
...
#### withMinZ( minZ : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #withMinZ data-toc-label='withMinZ' }
...
#### withMaxX( maxX : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #withMaxX data-toc-label='withMaxX' }
...
#### withMaxY( maxY : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #withMaxY data-toc-label='withMaxY' }
...
#### withMaxZ( maxZ : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #withMaxZ data-toc-label='withMaxZ' }
...
#### roundedOut() : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #roundedOut data-toc-label='roundedOut' }
...
#### roundedIn() : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #roundedIn data-toc-label='roundedIn' }
...
#### transformed( matrix : <span style="font-weight: 400; opacity: 80%;">Matrix4</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #transformed data-toc-label='transformed' }
...
#### dilated( d : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #dilated data-toc-label='dilated' }
...
#### dilatedX( x : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #dilatedX data-toc-label='dilatedX' }
...
#### dilatedY( y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #dilatedY data-toc-label='dilatedY' }
...
#### dilatedZ( z : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #dilatedZ data-toc-label='dilatedZ' }
...
#### dilatedXYZ( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span>, z : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #dilatedXYZ data-toc-label='dilatedXYZ' }
...
#### eroded( amount : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #eroded data-toc-label='eroded' }
...
#### erodedX( x : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #erodedX data-toc-label='erodedX' }
...
#### erodedY( y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #erodedY data-toc-label='erodedY' }
...
#### erodedZ( z : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #erodedZ data-toc-label='erodedZ' }
...
#### erodedXYZ( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span>, z : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #erodedXYZ data-toc-label='erodedXYZ' }
...
#### shiftedX( x : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #shiftedX data-toc-label='shiftedX' }
...
#### shiftedY( y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #shiftedY data-toc-label='shiftedY' }
...
#### shiftedZ( z : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #shiftedZ data-toc-label='shiftedZ' }
...
#### shiftedXYZ( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span>, z : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #shiftedXYZ data-toc-label='shiftedXYZ' }
...
#### shifted( v : <span style="font-weight: 400; opacity: 80%;">Vector3</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #shifted data-toc-label='shifted' }

Returns our bounds, translated by a vector, returned as a copy.

#### setMinMax( minX : <span style="font-weight: 400; opacity: 80%;">number</span>, minY : <span style="font-weight: 400; opacity: 80%;">number</span>, minZ : <span style="font-weight: 400; opacity: 80%;">number</span>, maxX : <span style="font-weight: 400; opacity: 80%;">number</span>, maxY : <span style="font-weight: 400; opacity: 80%;">number</span>, maxZ : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #setMinMax data-toc-label='setMinMax' }

Sets each value for this bounds, and returns itself.

#### setMinX( minX : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #setMinX data-toc-label='setMinX' }
...
#### setMinY( minY : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #setMinY data-toc-label='setMinY' }
...
#### setMinZ( minZ : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #setMinZ data-toc-label='setMinZ' }
...
#### setMaxX( maxX : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #setMaxX data-toc-label='setMaxX' }
...
#### setMaxY( maxY : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #setMaxY data-toc-label='setMaxY' }
...
#### setMaxZ( maxZ : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #setMaxZ data-toc-label='setMaxZ' }
...
#### set( bounds : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #set data-toc-label='set' }
...
#### includeBounds( bounds : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #includeBounds data-toc-label='includeBounds' }
...
#### constrainBounds( bounds : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #constrainBounds data-toc-label='constrainBounds' }
...
#### addCoordinates( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span>, z : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #addCoordinates data-toc-label='addCoordinates' }
...
#### addPoint( point : <span style="font-weight: 400; opacity: 80%;">Vector3</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #addPoint data-toc-label='addPoint' }
...
#### roundOut() : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #roundOut data-toc-label='roundOut' }
...
#### roundIn() : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #roundIn data-toc-label='roundIn' }
...
#### transform( matrix : <span style="font-weight: 400; opacity: 80%;">Matrix4</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #transform data-toc-label='transform' }
...
#### dilate( d : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #dilate data-toc-label='dilate' }
...
#### dilateX( x : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #dilateX data-toc-label='dilateX' }
...
#### dilateY( y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #dilateY data-toc-label='dilateY' }
...
#### dilateZ( z : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #dilateZ data-toc-label='dilateZ' }
...
#### dilateXYZ( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span>, z : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #dilateXYZ data-toc-label='dilateXYZ' }
...
#### erode( d : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #erode data-toc-label='erode' }
...
#### erodeX( x : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #erodeX data-toc-label='erodeX' }
...
#### erodeY( y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #erodeY data-toc-label='erodeY' }
...
#### erodeZ( z : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #erodeZ data-toc-label='erodeZ' }
...
#### erodeXYZ( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span>, z : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #erodeXYZ data-toc-label='erodeXYZ' }
...
#### shiftX( x : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #shiftX data-toc-label='shiftX' }
...
#### shiftY( y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #shiftY data-toc-label='shiftY' }
...
#### shiftZ( z : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #shiftZ data-toc-label='shiftZ' }
...
#### shiftXYZ( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span>, z : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #shiftXYZ data-toc-label='shiftXYZ' }
...
#### shift( v : <span style="font-weight: 400; opacity: 80%;">Vector3</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #shift data-toc-label='shift' }
...
#### cuboid( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span>, z : <span style="font-weight: 400; opacity: 80%;">number</span>, width : <span style="font-weight: 400; opacity: 80%;">number</span>, height : <span style="font-weight: 400; opacity: 80%;">number</span>, depth : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #cuboid data-toc-label='cuboid' }
...
#### point( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span>, z : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #point data-toc-label='point' }
...
#### NOTHING : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #NOTHING data-toc-label='NOTHING' }
...
#### EVERYTHING : <span style="font-weight: 400; opacity: 80%;">Bounds3</span> {: #EVERYTHING data-toc-label='EVERYTHING' }
...
#### Bounds3IO : <span style="font-weight: 400; opacity: 80%;">IOType</span> {: #Bounds3IO data-toc-label='Bounds3IO' }
