...
#### new Bounds2( minX : <span style="font-weight: 400; opacity: 80%;">number</span>, minY : <span style="font-weight: 400; opacity: 80%;">number</span>, maxX : <span style="font-weight: 400; opacity: 80%;">number</span>, maxY : <span style="font-weight: 400; opacity: 80%;">number</span> ) {: #constructor data-toc-label='constructor' }
...
#### getMinX() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getMinX data-toc-label='getMinX' }

Alias for minX, supporting the explicit getter function style.

#### getMinY() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getMinY data-toc-label='getMinY' }

Alias for minY, supporting the explicit getter function style.

#### getMaxX() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getMaxX data-toc-label='getMaxX' }

Alias for maxX, supporting the explicit getter function style.

#### getMaxY() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getMaxY data-toc-label='getMaxY' }
...
#### hasNonzeroArea() : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #hasNonzeroArea data-toc-label='hasNonzeroArea' }
...
#### closestPointTo( point : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #closestPointTo data-toc-label='closestPointTo' }
...
#### closestBoundaryPointTo( point : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #closestBoundaryPointTo data-toc-label='closestBoundaryPointTo' }

Find the point on the boundary of the Bounds2 that is closest to the provided point.

#### getConstrainedPoint( point : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #getConstrainedPoint data-toc-label='getConstrainedPoint' }

Give a point outside of this Bounds2, constrain it to a point on the boundary of this Bounds2.

#### containsCoordinates( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #containsCoordinates data-toc-label='containsCoordinates' }
...
#### containsBounds( bounds : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> ) : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #containsBounds data-toc-label='containsBounds' }
...
#### minimumDistanceToPointSquared( point : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">number</span> {: #minimumDistanceToPointSquared data-toc-label='minimumDistanceToPointSquared' }

The squared distance from the input point to the point closest to it inside the bounding box.

#### maximumDistanceToPointSquared( point : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">number</span> {: #maximumDistanceToPointSquared data-toc-label='maximumDistanceToPointSquared' }
...
#### equals( other : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> ) : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #equals data-toc-label='equals' }

Exact equality comparison between this bounds and another bounds.

@returns - Whether the two bounds are equal

#### equalsEpsilon( other : <span style="font-weight: 400; opacity: 80%;">Bounds2</span>, epsilon : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #equalsEpsilon data-toc-label='equalsEpsilon' }
...
#### copy( bounds? : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #copy data-toc-label='copy' }
...
#### union( bounds : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #union data-toc-label='union' }
...
#### intersection( bounds : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #intersection data-toc-label='intersection' }
...
#### withCoordinates( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #withCoordinates data-toc-label='withCoordinates' }
...
#### withPoint( point : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #withPoint data-toc-label='withPoint' }
...
#### withX( x : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #withX data-toc-label='withX' }
...
#### withY( y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #withY data-toc-label='withY' }
...
#### withMinX( minX : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #withMinX data-toc-label='withMinX' }
...
#### withMinY( minY : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #withMinY data-toc-label='withMinY' }
...
#### withMaxX( maxX : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #withMaxX data-toc-label='withMaxX' }
...
#### withMaxY( maxY : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #withMaxY data-toc-label='withMaxY' }
...
#### roundedOut() : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #roundedOut data-toc-label='roundedOut' }
...
#### roundedIn() : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #roundedIn data-toc-label='roundedIn' }
...
#### transformed( matrix : <span style="font-weight: 400; opacity: 80%;">Matrix3</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #transformed data-toc-label='transformed' }
...
#### dilated( d : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #dilated data-toc-label='dilated' }
...
#### dilatedX( x : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #dilatedX data-toc-label='dilatedX' }
...
#### dilatedY( y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #dilatedY data-toc-label='dilatedY' }
...
#### dilatedXY( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #dilatedXY data-toc-label='dilatedXY' }
...
#### eroded( amount : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #eroded data-toc-label='eroded' }
...
#### erodedX( x : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #erodedX data-toc-label='erodedX' }
...
#### erodedY( y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #erodedY data-toc-label='erodedY' }
...
#### erodedXY( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #erodedXY data-toc-label='erodedXY' }
...
#### withOffsets( left : <span style="font-weight: 400; opacity: 80%;">number</span>, top : <span style="font-weight: 400; opacity: 80%;">number</span>, right : <span style="font-weight: 400; opacity: 80%;">number</span>, bottom : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #withOffsets data-toc-label='withOffsets' }
...
#### shiftedX( x : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #shiftedX data-toc-label='shiftedX' }
...
#### shiftedY( y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #shiftedY data-toc-label='shiftedY' }
...
#### shiftedXY( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #shiftedXY data-toc-label='shiftedXY' }
...
#### shifted( v : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #shifted data-toc-label='shifted' }

Returns our bounds, translated by a vector, returned as a copy.

#### blend( bounds : <span style="font-weight: 400; opacity: 80%;">Bounds2</span>, ratio : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #blend data-toc-label='blend' }
...
#### setMinMax( minX : <span style="font-weight: 400; opacity: 80%;">number</span>, minY : <span style="font-weight: 400; opacity: 80%;">number</span>, maxX : <span style="font-weight: 400; opacity: 80%;">number</span>, maxY : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #setMinMax data-toc-label='setMinMax' }

Sets each value for this bounds, and returns itself.

#### setMinX( minX : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #setMinX data-toc-label='setMinX' }
...
#### setMinY( minY : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #setMinY data-toc-label='setMinY' }
...
#### setMaxX( maxX : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #setMaxX data-toc-label='setMaxX' }
...
#### setMaxY( maxY : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #setMaxY data-toc-label='setMaxY' }
...
#### set( bounds : <span style="font-weight: 400; opacity: 80%;">Bounds2Like</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #set data-toc-label='set' }
...
#### includeBounds( bounds : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #includeBounds data-toc-label='includeBounds' }
...
#### constrainBounds( bounds : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #constrainBounds data-toc-label='constrainBounds' }
...
#### addCoordinates( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #addCoordinates data-toc-label='addCoordinates' }
...
#### addPoint( point : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #addPoint data-toc-label='addPoint' }
...
#### addX( x : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #addX data-toc-label='addX' }
...
#### addY( y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #addY data-toc-label='addY' }
...
#### roundOut() : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #roundOut data-toc-label='roundOut' }
...
#### roundIn() : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #roundIn data-toc-label='roundIn' }
...
#### transform( matrix : <span style="font-weight: 400; opacity: 80%;">Matrix3</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #transform data-toc-label='transform' }
...
#### dilate( d : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #dilate data-toc-label='dilate' }
...
#### dilateX( x : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #dilateX data-toc-label='dilateX' }
...
#### dilateY( y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #dilateY data-toc-label='dilateY' }
...
#### dilateXY( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #dilateXY data-toc-label='dilateXY' }
...
#### erode( d : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #erode data-toc-label='erode' }
...
#### erodeX( x : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #erodeX data-toc-label='erodeX' }
...
#### erodeY( y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #erodeY data-toc-label='erodeY' }
...
#### erodeXY( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #erodeXY data-toc-label='erodeXY' }
...
#### offset( left : <span style="font-weight: 400; opacity: 80%;">number</span>, top : <span style="font-weight: 400; opacity: 80%;">number</span>, right : <span style="font-weight: 400; opacity: 80%;">number</span>, bottom : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #offset data-toc-label='offset' }
...
#### shiftX( x : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #shiftX data-toc-label='shiftX' }
...
#### shiftY( y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #shiftY data-toc-label='shiftY' }
...
#### shiftXY( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #shiftXY data-toc-label='shiftXY' }
...
#### shift( v : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #shift data-toc-label='shift' }

Translates our bounds by the given vector.

#### getXRange() : <span style="font-weight: 400; opacity: 80%;">Range</span> {: #getXRange data-toc-label='getXRange' }

Returns the range of the x-values of this bounds.

#### setXRange( range : <span style="font-weight: 400; opacity: 80%;">Range</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #setXRange data-toc-label='setXRange' }

Sets the x-range of this bounds.

#### getYRange() : <span style="font-weight: 400; opacity: 80%;">Range</span> {: #getYRange data-toc-label='getYRange' }

Returns the range of the y-values of this bounds.

#### setYRange( range : <span style="font-weight: 400; opacity: 80%;">Range</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #setYRange data-toc-label='setYRange' }

Sets the y-range of this bounds.

#### getClosestPoint( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span>, result? : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #getClosestPoint data-toc-label='getClosestPoint' }
...
#### minX : <span style="font-weight: 400; opacity: 80%;">number</span> {: #minX data-toc-label='minX' }

The minimum X coordinate of the bounds.

#### minY : <span style="font-weight: 400; opacity: 80%;">number</span> {: #minY data-toc-label='minY' }

The minimum Y coordinate of the bounds.

#### maxX : <span style="font-weight: 400; opacity: 80%;">number</span> {: #maxX data-toc-label='maxX' }

The maximum X coordinate of the bounds.

#### maxY : <span style="font-weight: 400; opacity: 80%;">number</span> {: #maxY data-toc-label='maxY' }

The maximum Y coordinate of the bounds.

#### isBounds : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #isBounds data-toc-label='isBounds' }
...
#### create( bounds : <span style="font-weight: 400; opacity: 80%;">Bounds2Like</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #create data-toc-label='create' }

Static factory method

#### rect( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span>, width : <span style="font-weight: 400; opacity: 80%;">number</span>, height : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #rect data-toc-label='rect' }
...
#### oriented( orientation : <span style="font-weight: 400; opacity: 80%;">Orientation</span>, minPrimary : <span style="font-weight: 400; opacity: 80%;">number</span>, minSecondary : <span style="font-weight: 400; opacity: 80%;">number</span>, maxPrimary : <span style="font-weight: 400; opacity: 80%;">number</span>, maxSecondary : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #oriented data-toc-label='oriented' }
...
#### point( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #point data-toc-label='point' }
...
#### point( v : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #point data-toc-label='point' }

#### point( x : <span style="font-weight: 400; opacity: 80%;">Vector2 | number</span>, y? : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #point data-toc-label='point' }
...
#### NOTHING : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #NOTHING data-toc-label='NOTHING' }
...
#### EVERYTHING : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #EVERYTHING data-toc-label='EVERYTHING' }
...
#### Bounds2IO : <span style="font-weight: 400; opacity: 80%;">IOType</span> {: #Bounds2IO data-toc-label='Bounds2IO' }
