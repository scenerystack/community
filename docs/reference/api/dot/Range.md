...
!!! warning "Under Construction"
    ...
    [https://github.com/phetsims/dot/blob/main/js/Range.ts](https://github.com/phetsims/dot/blob/main/js/Range.ts) for the most up-to-date information.
...
#### new Range( min : <span style="font-weight: 400;"><span style="color: hsla(calc(var(--md-hue) + 180deg),80%,40%,1);">number</span></span>, max : <span style="font-weight: 400;"><span style="color: hsla(calc(var(--md-hue) + 180deg),80%,40%,1);">number</span></span> ) {: #Range-constructor data-toc-label='new Range' }
