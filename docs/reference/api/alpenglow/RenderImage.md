...
!!! warning "Under Construction"
    ...
    [https://github.com/phetsims/alpenglow/blob/main/js/render-program/RenderImage.ts](https://github.com/phetsims/alpenglow/blob/main/js/render-program/RenderImage.ts) for the most up-to-date information.
