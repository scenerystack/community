...
!!! warning "Under Construction"
    ...
    [https://github.com/phetsims/vegas/blob/main/js/InfiniteStatusBar.ts](https://github.com/phetsims/vegas/blob/main/js/InfiniteStatusBar.ts) for the most up-to-date information.
