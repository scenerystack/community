...
#### new ReadOnlyProperty( value : <span style="font-weight: 400; opacity: 80%;">T</span>, providedOptions? : <span style="font-weight: 400; opacity: 80%;">PropertyOptions&lt;T&gt;</span> ) {: #constructor data-toc-label='constructor' }
...
#### unguardedSet( value : <span style="font-weight: 400; opacity: 80%;">T</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #unguardedSet data-toc-label='unguardedSet' }
...
#### notifyListenersStatic() : <span style="font-weight: 400; opacity: 80%;">void</span> {: #notifyListenersStatic data-toc-label='notifyListenersStatic' }
...
#### addPhetioStateDependencies( dependencies : <span style="font-weight: 400; opacity: 80%;">Array&lt;TReadOnlyProperty&lt;IntentionalAny&gt;&gt;</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #addPhetioStateDependencies data-toc-label='addPhetioStateDependencies' }
...
#### link( listener : <span style="font-weight: 400; opacity: 80%;">PropertyLinkListener&lt;T&gt;</span>, options? : <span style="font-weight: 400; opacity: 80%;">ReadOnlyPropertyLinkOptions</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #link data-toc-label='link' }
...
#### lazyLink( listener : <span style="font-weight: 400; opacity: 80%;">PropertyLazyLinkListener&lt;T&gt;</span>, options? : <span style="font-weight: 400; opacity: 80%;">ReadOnlyPropertyLinkOptions</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #lazyLink data-toc-label='lazyLink' }
...
#### linkAttribute( object : <span style="font-weight: 400; opacity: 80%;">IntentionalAny</span>, attributeName : <span style="font-weight: 400; opacity: 80%;">string</span> ) : <span style="font-weight: 400; opacity: 80%;">( value: T ) =&gt; void</span> {: #linkAttribute data-toc-label='linkAttribute' }
...
#### debug( name : <span style="font-weight: 400; opacity: 80%;">string</span> ) : <span style="font-weight: 400; opacity: 80%;">( value: T ) =&gt; void</span> {: #debug data-toc-label='debug' }
...
#### isValueValid( value : <span style="font-weight: 400; opacity: 80%;">T</span> ) : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #isValueValid data-toc-label='isValueValid' }

#### getValidationError( value : <span style="font-weight: 400; opacity: 80%;">T</span> ) : <span style="font-weight: 400; opacity: 80%;">string | null</span> {: #getValidationError data-toc-label='getValidationError' }

#### dispose() : <span style="font-weight: 400; opacity: 80%;">void</span> {: #dispose data-toc-label='dispose' }

Ensures that the Property is eligible for GC

#### hasListener( listener : <span style="font-weight: 400; opacity: 80%;">PropertyLinkListener&lt;T&gt;</span> ) : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #hasListener data-toc-label='hasListener' }

Checks whether a listener is registered with this Property

#### forEachListener( callback : <span style="font-weight: 400; opacity: 80%;">( value: ( ...args: [ T, T | null, TinyProperty&lt;T&gt; | ReadOnlyProperty&lt;T&gt; ] ) =&gt; void ) =&gt; void</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #forEachListener data-toc-label='forEachListener' }
...
#### toStateObject() : <span style="font-weight: 400; opacity: 80%;">ReadOnlyPropertyState&lt;StateType&gt;</span> {: #toStateObject data-toc-label='toStateObject' }
...
#### applyState( stateObject : <span style="font-weight: 400; opacity: 80%;">ReadOnlyPropertyState&lt;StateType&gt;</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #applyState data-toc-label='applyState' }
...
#### units : <span style="font-weight: 400; opacity: 80%;">Units | null</span> {: #units data-toc-label='units' }

(readonly)

(phet-io) Units, if any.  See units.js for valid values

#### validValues : <span style="font-weight: 400; opacity: 80%;">readonly T[]</span> {: #validValues data-toc-label='validValues' }

(readonly)

#### isDeferred : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #isDeferred data-toc-label='isDeferred' }
...
#### deferredValue : <span style="font-weight: 400; opacity: 80%;">T | null</span> {: #deferredValue data-toc-label='deferredValue' }

(protected)

the value that this Property will take after no longer deferred

#### hasDeferredValue : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #hasDeferredValue data-toc-label='hasDeferredValue' }

(protected)

whether a deferred value has been set

#### valueValidator : <span style="font-weight: 400; opacity: 80%;">Validator&lt;T&gt;</span> {: #valueValidator data-toc-label='valueValidator' }

(protected, readonly)

#### phetioValueType : <span style="font-weight: 400; opacity: 80%;">IOType</span> {: #phetioValueType data-toc-label='phetioValueType' }
...
#### PropertyIO( parameterType : <span style="font-weight: 400; opacity: 80%;">IOType&lt;T, StateType&gt;</span> ) : <span style="font-weight: 400; opacity: 80%;">IOType</span> {: #PropertyIO data-toc-label='PropertyIO' }
