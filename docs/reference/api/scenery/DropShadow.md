...
!!! warning "Under Construction"
    ...
    [https://github.com/phetsims/scenery/blob/main/js/filters/DropShadow.ts](https://github.com/phetsims/scenery/blob/main/js/filters/DropShadow.ts) for the most up-to-date information.
