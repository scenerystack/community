...
#### new PressListener( providedOptions? : <span style="font-weight: 400; opacity: 80%;">PressListenerOptions</span> ) {: #constructor data-toc-label='constructor' }
...
#### clearOverPointers() : <span style="font-weight: 400; opacity: 80%;">void</span> {: #clearOverPointers data-toc-label='clearOverPointers' }
...
#### step() : <span style="font-weight: 400; opacity: 80%;">void</span> {: #step data-toc-label='step' }

If collapseDragEvents is set to true, this step() should be called every frame so that the collapsed drag
can be fired.

#### setCreatePanTargetBounds( createDragPanTargetBounds : <span style="font-weight: 400; opacity: 80%;">( () =&gt; Bounds2 ) | null</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #setCreatePanTargetBounds data-toc-label='setCreatePanTargetBounds' }
...
#### setCreatePanTargetBoundsFromTrail( trail : <span style="font-weight: 400; opacity: 80%;">Trail</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #setCreatePanTargetBoundsFromTrail data-toc-label='setCreatePanTargetBoundsFromTrail' }
...
#### overPointers : <span style="font-weight: 400; opacity: 80%;">ObservableArray&lt;Pointer&gt;</span> {: #overPointers data-toc-label='overPointers' }
...
#### isOverProperty : <span style="font-weight: 400; opacity: 80%;">TProperty&lt;boolean&gt;</span> {: #isOverProperty data-toc-label='isOverProperty' }
...
#### looksOverProperty : <span style="font-weight: 400; opacity: 80%;">TProperty&lt;boolean&gt;</span> {: #looksOverProperty data-toc-label='looksOverProperty' }
...
#### isHoveringProperty : <span style="font-weight: 400; opacity: 80%;">TProperty&lt;boolean&gt;</span> {: #isHoveringProperty data-toc-label='isHoveringProperty' }
...
#### isHighlightedProperty : <span style="font-weight: 400; opacity: 80%;">TProperty&lt;boolean&gt;</span> {: #isHighlightedProperty data-toc-label='isHighlightedProperty' }
...
#### isFocusedProperty : <span style="font-weight: 400; opacity: 80%;">TProperty&lt;boolean&gt;</span> {: #isFocusedProperty data-toc-label='isFocusedProperty' }

(readonly)

(read-only) - Whether the listener has focus (should appear to be over)

#### pointer : <span style="font-weight: 400; opacity: 80%;">Pointer | null</span> {: #pointer data-toc-label='pointer' }
...
#### pressedTrail : <span style="font-weight: 400; opacity: 80%;">Trail | null</span> {: #pressedTrail data-toc-label='pressedTrail' }
...
#### pdomClickingProperty : <span style="font-weight: 400; opacity: 80%;">TProperty&lt;boolean&gt;</span> {: #pdomClickingProperty data-toc-label='pdomClickingProperty' }

(readonly)

(read-only) - Whether a press is being processed from a pdom click input event from the PDOM.

#### looksPressedProperty : <span style="font-weight: 400; opacity: 80%;">TReadOnlyProperty&lt;boolean&gt;</span> {: #looksPressedProperty data-toc-label='looksPressedProperty' }
...
#### display : <span style="font-weight: 400; opacity: 80%;">Display | null</span> {: #display data-toc-label='display' }
