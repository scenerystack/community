...
!!! warning "Under Construction"
    ...
    [https://github.com/phetsims/scenery/blob/main/js/filters/GaussianBlur.ts](https://github.com/phetsims/scenery/blob/main/js/filters/GaussianBlur.ts) for the most up-to-date information.
