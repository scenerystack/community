...
#### new Node( options? : <span style="font-weight: 400; opacity: 80%;">NodeOptions</span> ) {: #constructor data-toc-label='constructor' }

### Instance Methods

#### moveChildToIndex( node : <span style="font-weight: 400; opacity: 80%;">Node</span>, index : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #moveChildToIndex data-toc-label='moveChildToIndex' }
...
#### removeAllChildren() : <span style="font-weight: 400; opacity: 80%;">this</span> {: #removeAllChildren data-toc-label='removeAllChildren' }
...
#### getChildren() : <span style="font-weight: 400; opacity: 80%;">Node[]</span> {: #getChildren data-toc-label='getChildren' }
...
#### getChildrenCount() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getChildrenCount data-toc-label='getChildrenCount' }

Returns a count of children, without needing to make a defensive copy.

#### getParents() : <span style="font-weight: 400; opacity: 80%;">Node[]</span> {: #getParents data-toc-label='getParents' }
...
#### getParent() : <span style="font-weight: 400; opacity: 80%;">Node | null</span> {: #getParent data-toc-label='getParent' }

Returns a single parent if it exists, otherwise null (no parents), or an assertion failure (multiple parents).

#### getChildAt( index : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Node</span> {: #getChildAt data-toc-label='getChildAt' }

Gets the child at a specific index into the children array.

#### indexOfParent( parent : <span style="font-weight: 400; opacity: 80%;">Node</span> ) : <span style="font-weight: 400; opacity: 80%;">number</span> {: #indexOfParent data-toc-label='indexOfParent' }
...
#### indexOfChild( child : <span style="font-weight: 400; opacity: 80%;">Node</span> ) : <span style="font-weight: 400; opacity: 80%;">number</span> {: #indexOfChild data-toc-label='indexOfChild' }
...
#### moveToFront() : <span style="font-weight: 400; opacity: 80%;">this</span> {: #moveToFront data-toc-label='moveToFront' }

Moves this Node to the front (end) of all of its parents children array.

#### moveChildToFront( child : <span style="font-weight: 400; opacity: 80%;">Node</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #moveChildToFront data-toc-label='moveChildToFront' }

Moves one of our children to the front (end) of our children array.

@param child - Our child to move to the front.

#### moveForward() : <span style="font-weight: 400; opacity: 80%;">this</span> {: #moveForward data-toc-label='moveForward' }

Move this node one index forward in each of its parents.  If the Node is already at the front, this is a no-op.

#### moveChildForward( child : <span style="font-weight: 400; opacity: 80%;">Node</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #moveChildForward data-toc-label='moveChildForward' }

Moves the specified child forward by one index.  If the child is already at the front, this is a no-op.

#### moveBackward() : <span style="font-weight: 400; opacity: 80%;">this</span> {: #moveBackward data-toc-label='moveBackward' }

Move this node one index backward in each of its parents.  If the Node is already at the back, this is a no-op.

#### moveChildBackward( child : <span style="font-weight: 400; opacity: 80%;">Node</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #moveChildBackward data-toc-label='moveChildBackward' }

Moves the specified child forward by one index.  If the child is already at the back, this is a no-op.

#### moveToBack() : <span style="font-weight: 400; opacity: 80%;">this</span> {: #moveToBack data-toc-label='moveToBack' }

Moves this Node to the back (front) of all of its parents children array.

#### moveChildToBack( child : <span style="font-weight: 400; opacity: 80%;">Node</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #moveChildToBack data-toc-label='moveChildToBack' }

Moves one of our children to the back (front) of our children array.

@param child - Our child to move to the back.

#### replaceChild( oldChild : <span style="font-weight: 400; opacity: 80%;">Node</span>, newChild : <span style="font-weight: 400; opacity: 80%;">Node</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #replaceChild data-toc-label='replaceChild' }
...
#### detach() : <span style="font-weight: 400; opacity: 80%;">this</span> {: #detach data-toc-label='detach' }

Removes this Node from all of its parents.

#### validateSelfBounds() : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #validateSelfBounds data-toc-label='validateSelfBounds' }
...
#### validateBounds() : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #validateBounds data-toc-label='validateBounds' }
...
#### invalidateBounds() : <span style="font-weight: 400; opacity: 80%;">void</span> {: #invalidateBounds data-toc-label='invalidateBounds' }

Marks the bounds of this Node as invalid, so they are recomputed before being accessed again.

#### invalidateSelf( newSelfBounds? : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #invalidateSelf data-toc-label='invalidateSelf' }
...
#### hasChild( potentialChild : <span style="font-weight: 400; opacity: 80%;">Node</span> ) : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #hasChild data-toc-label='hasChild' }
...
#### getSelfBounds() : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #getSelfBounds data-toc-label='getSelfBounds' }
...
#### getChildBounds() : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #getChildBounds data-toc-label='getChildBounds' }
...
#### getLocalBounds() : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #getLocalBounds data-toc-label='getLocalBounds' }
...
#### setLocalBounds( localBounds : <span style="font-weight: 400; opacity: 80%;">Bounds2 | null</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setLocalBounds data-toc-label='setLocalBounds' }
...
#### getSafeTransformedVisibleBounds( matrix? : <span style="font-weight: 400; opacity: 80%;">Matrix3</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #getSafeTransformedVisibleBounds data-toc-label='getSafeTransformedVisibleBounds' }
...
#### setTransformBounds( transformBounds : <span style="font-weight: 400; opacity: 80%;">boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setTransformBounds data-toc-label='setTransformBounds' }
...
#### getTransformBounds() : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #getTransformBounds data-toc-label='getTransformBounds' }
...
#### getVisibleLocalBounds() : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #getVisibleLocalBounds data-toc-label='getVisibleLocalBounds' }

Like getLocalBounds() in the "local" coordinate frame, but includes only visible nodes.

#### getVisibleBounds() : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #getVisibleBounds data-toc-label='getVisibleBounds' }

Like getBounds() in the "parent" coordinate frame, but includes only visible nodes

#### hitTest( point : <span style="font-weight: 400; opacity: 80%;">Vector2</span>, isMouse? : <span style="font-weight: 400; opacity: 80%;">boolean</span>, isTouch? : <span style="font-weight: 400; opacity: 80%;">boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">Trail | null</span> {: #hitTest data-toc-label='hitTest' }
...
#### trailUnderPointer( pointer : <span style="font-weight: 400; opacity: 80%;">Pointer</span> ) : <span style="font-weight: 400; opacity: 80%;">Trail | null</span> {: #trailUnderPointer data-toc-label='trailUnderPointer' }
...
#### isPhetioMouseHittable( point : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #isPhetioMouseHittable data-toc-label='isPhetioMouseHittable' }
...
#### isAnyDescendantAPhetioMouseHitTarget() : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #isAnyDescendantAPhetioMouseHitTarget data-toc-label='isAnyDescendantAPhetioMouseHitTarget' }
...
#### hasParent() : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #hasParent data-toc-label='hasParent' }

Returns whether this Node has any parents at all.

#### hasChildren() : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #hasChildren data-toc-label='hasChildren' }

Returns whether this Node has any children at all.

#### isChildIncludedInLayout( child : <span style="font-weight: 400; opacity: 80%;">Node</span> ) : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #isChildIncludedInLayout data-toc-label='isChildIncludedInLayout' }

Returns whether a child should be included for layout (if this Node is a layout container).

#### walkDepthFirst( callback : <span style="font-weight: 400; opacity: 80%;">( node: Node ) =&gt; void</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #walkDepthFirst data-toc-label='walkDepthFirst' }

Calls the callback on nodes recursively in a depth-first manner.

#### addInputListener( listener : <span style="font-weight: 400; opacity: 80%;">TInputListener</span>, options? : <span style="font-weight: 400; opacity: 80%;">DisposerOptions</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #addInputListener data-toc-label='addInputListener' }
...
#### removeInputListener( listener : <span style="font-weight: 400; opacity: 80%;">TInputListener</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #removeInputListener data-toc-label='removeInputListener' }

Removes an input listener that was previously added with addInputListener.

#### hasInputListener( listener : <span style="font-weight: 400; opacity: 80%;">TInputListener</span> ) : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #hasInputListener data-toc-label='hasInputListener' }
...
#### interruptInput() : <span style="font-weight: 400; opacity: 80%;">this</span> {: #interruptInput data-toc-label='interruptInput' }
...
#### translate( v : <span style="font-weight: 400; opacity: 80%;">Vector2</span>, prependInstead? : <span style="font-weight: 400; opacity: 80%;">boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #translate data-toc-label='translate' }
...
#### translate( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span>, prependInstead? : <span style="font-weight: 400; opacity: 80%;">boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #translate data-toc-label='translate' }

#### translate( x : <span style="font-weight: 400; opacity: 80%;">number | Vector2</span>, y? : <span style="font-weight: 400; opacity: 80%;">number | boolean</span>, prependInstead? : <span style="font-weight: 400; opacity: 80%;">boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #translate data-toc-label='translate' }

#### scale( s : <span style="font-weight: 400; opacity: 80%;">number</span>, prependInstead? : <span style="font-weight: 400; opacity: 80%;">boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #scale data-toc-label='scale' }
...
#### scale( s : <span style="font-weight: 400; opacity: 80%;">Vector2</span>, prependInstead? : <span style="font-weight: 400; opacity: 80%;">boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #scale data-toc-label='scale' }

#### scale( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span>, prependInstead? : <span style="font-weight: 400; opacity: 80%;">boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #scale data-toc-label='scale' }

#### scale( x : <span style="font-weight: 400; opacity: 80%;">number | Vector2</span>, y? : <span style="font-weight: 400; opacity: 80%;">number | boolean</span>, prependInstead? : <span style="font-weight: 400; opacity: 80%;">boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #scale data-toc-label='scale' }

#### rotate( angle : <span style="font-weight: 400; opacity: 80%;">number</span>, prependInstead? : <span style="font-weight: 400; opacity: 80%;">boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #rotate data-toc-label='rotate' }
...
#### rotateAround( point : <span style="font-weight: 400; opacity: 80%;">Vector2</span>, angle : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #rotateAround data-toc-label='rotateAround' }
...
#### setX( x : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setX data-toc-label='setX' }

Shifts the x coordinate (in the parent coordinate frame) of where the node's origin is transformed to.

#### getX() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getX data-toc-label='getX' }

Returns the x coordinate (in the parent coordinate frame) of where the node's origin is transformed to.

#### setY( y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setY data-toc-label='setY' }

Shifts the y coordinate (in the parent coordinate frame) of where the node's origin is transformed to.

#### getY() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getY data-toc-label='getY' }

Returns the y coordinate (in the parent coordinate frame) of where the node's origin is transformed to.

#### setScaleMagnitude( s : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setScaleMagnitude data-toc-label='setScaleMagnitude' }
...
#### setScaleMagnitude( v : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setScaleMagnitude data-toc-label='setScaleMagnitude' }

#### setScaleMagnitude( sx : <span style="font-weight: 400; opacity: 80%;">number</span>, sy : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setScaleMagnitude data-toc-label='setScaleMagnitude' }

#### setScaleMagnitude( a : <span style="font-weight: 400; opacity: 80%;">number | Vector2</span>, b? : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setScaleMagnitude data-toc-label='setScaleMagnitude' }
...
#### setTranslation( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setTranslation data-toc-label='setTranslation' }
...
#### setTranslation( v : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setTranslation data-toc-label='setTranslation' }

#### setTranslation( a : <span style="font-weight: 400; opacity: 80%;">number | Vector2</span>, b? : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setTranslation data-toc-label='setTranslation' }
...
#### appendMatrix( matrix : <span style="font-weight: 400; opacity: 80%;">Matrix3</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #appendMatrix data-toc-label='appendMatrix' }
...
#### prependMatrix( matrix : <span style="font-weight: 400; opacity: 80%;">Matrix3</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #prependMatrix data-toc-label='prependMatrix' }
...
#### prependTranslation( x : <span style="font-weight: 400; opacity: 80%;">number</span>, y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #prependTranslation data-toc-label='prependTranslation' }
...
#### setMatrix( matrix : <span style="font-weight: 400; opacity: 80%;">Matrix3</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #setMatrix data-toc-label='setMatrix' }
...
#### auditMaxDimensions() : <span style="font-weight: 400; opacity: 80%;">void</span> {: #auditMaxDimensions data-toc-label='auditMaxDimensions' }
...
#### setMaxWidth( maxWidth : <span style="font-weight: 400; opacity: 80%;">number | null</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #setMaxWidth data-toc-label='setMaxWidth' }

Sets the maximum width of the Node (see constructor for documentation on how maximum dimensions work).

#### getMaxWidth() : <span style="font-weight: 400; opacity: 80%;">number | null</span> {: #getMaxWidth data-toc-label='getMaxWidth' }

Returns the maximum width (if any) of the Node.

#### setMaxHeight( maxHeight : <span style="font-weight: 400; opacity: 80%;">number | null</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #setMaxHeight data-toc-label='setMaxHeight' }

Sets the maximum height of the Node (see constructor for documentation on how maximum dimensions work).

#### getMaxHeight() : <span style="font-weight: 400; opacity: 80%;">number | null</span> {: #getMaxHeight data-toc-label='getMaxHeight' }

Returns the maximum height (if any) of the Node.

#### setLeft( left : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setLeft data-toc-label='setLeft' }
...
#### getLeft() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getLeft data-toc-label='getLeft' }

Returns the X value of the left side of the bounding box of this Node (in the parent coordinate frame).

NOTE: This may require computation of this node's subtree bounds, which may incur some performance loss.

#### setRight( right : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setRight data-toc-label='setRight' }
...
#### getRight() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getRight data-toc-label='getRight' }

Returns the X value of the right side of the bounding box of this Node (in the parent coordinate frame).

NOTE: This may require computation of this node's subtree bounds, which may incur some performance loss.

#### setCenterX( x : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setCenterX data-toc-label='setCenterX' }
...
#### setCenterY( y : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setCenterY data-toc-label='setCenterY' }
...
#### setTop( top : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setTop data-toc-label='setTop' }
...
#### getTop() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getTop data-toc-label='getTop' }

Returns the lowest Y value of this node's bounding box (in the parent coordinate frame).

NOTE: This may require computation of this node's subtree bounds, which may incur some performance loss.

#### setBottom( bottom : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setBottom data-toc-label='setBottom' }
...
#### getBottom() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getBottom data-toc-label='getBottom' }

Returns the highest Y value of this node's bounding box (in the parent coordinate frame).

NOTE: This may require computation of this node's subtree bounds, which may incur some performance loss.

#### setLeftTop( leftTop : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setLeftTop data-toc-label='setLeftTop' }

Sets the position of the upper-left corner of this node's bounds to the specified point.

#### getLeftTop() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #getLeftTop data-toc-label='getLeftTop' }

Returns the upper-left corner of this node's bounds.

#### setCenterTop( centerTop : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setCenterTop data-toc-label='setCenterTop' }

Sets the position of the center-top location of this node's bounds to the specified point.

#### getCenterTop() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #getCenterTop data-toc-label='getCenterTop' }

Returns the center-top location of this node's bounds.

#### setRightTop( rightTop : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setRightTop data-toc-label='setRightTop' }

Sets the position of the upper-right corner of this node's bounds to the specified point.

#### getRightTop() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #getRightTop data-toc-label='getRightTop' }

Returns the upper-right corner of this node's bounds.

#### setLeftCenter( leftCenter : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setLeftCenter data-toc-label='setLeftCenter' }

Sets the position of the center-left of this node's bounds to the specified point.

#### getLeftCenter() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #getLeftCenter data-toc-label='getLeftCenter' }
...
#### setRightCenter( rightCenter : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setRightCenter data-toc-label='setRightCenter' }

Sets the position of the center-right of this node's bounds to the specified point.

#### getRightCenter() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #getRightCenter data-toc-label='getRightCenter' }

Returns the center-right of this node's bounds.

#### setLeftBottom( leftBottom : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setLeftBottom data-toc-label='setLeftBottom' }

Sets the position of the lower-left corner of this node's bounds to the specified point.

#### getLeftBottom() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #getLeftBottom data-toc-label='getLeftBottom' }

Returns the lower-left corner of this node's bounds.

#### setCenterBottom( centerBottom : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setCenterBottom data-toc-label='setCenterBottom' }

Sets the position of the center-bottom of this node's bounds to the specified point.

#### getCenterBottom() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #getCenterBottom data-toc-label='getCenterBottom' }

Returns the center-bottom of this node's bounds.

#### setRightBottom( rightBottom : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setRightBottom data-toc-label='setRightBottom' }

Sets the position of the lower-right corner of this node's bounds to the specified point.

#### getRightBottom() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #getRightBottom data-toc-label='getRightBottom' }

Returns the lower-right corner of this node's bounds.

#### getWidth() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getWidth data-toc-label='getWidth' }

Returns the width of this node's bounding box (in the parent coordinate frame).

NOTE: This may require computation of this node's subtree bounds, which may incur some performance loss.

#### getHeight() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getHeight data-toc-label='getHeight' }

Returns the height of this node's bounding box (in the parent coordinate frame).

NOTE: This may require computation of this node's subtree bounds, which may incur some performance loss.

#### getLocalWidth() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getLocalWidth data-toc-label='getLocalWidth' }

Returns the width of this node's bounding box (in the local coordinate frame).

NOTE: This may require computation of this node's subtree bounds, which may incur some performance loss.

#### getLocalHeight() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getLocalHeight data-toc-label='getLocalHeight' }

Returns the height of this node's bounding box (in the local coordinate frame).

NOTE: This may require computation of this node's subtree bounds, which may incur some performance loss.

#### getLocalLeft() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getLocalLeft data-toc-label='getLocalLeft' }

Returns the X value of the left side of the bounding box of this Node (in the local coordinate frame).

NOTE: This may require computation of this node's subtree bounds, which may incur some performance loss.

#### getLocalRight() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getLocalRight data-toc-label='getLocalRight' }

Returns the X value of the right side of the bounding box of this Node (in the local coordinate frame).

NOTE: This may require computation of this node's subtree bounds, which may incur some performance loss.

#### getLocalCenterX() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getLocalCenterX data-toc-label='getLocalCenterX' }

Returns the X value of this node's horizontal center (in the local coordinate frame)

NOTE: This may require computation of this node's subtree bounds, which may incur some performance loss.

#### getLocalCenterY() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getLocalCenterY data-toc-label='getLocalCenterY' }

Returns the Y value of this node's vertical center (in the local coordinate frame)

NOTE: This may require computation of this node's subtree bounds, which may incur some performance loss.

#### getLocalTop() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getLocalTop data-toc-label='getLocalTop' }

Returns the lowest Y value of this node's bounding box (in the local coordinate frame).

NOTE: This may require computation of this node's subtree bounds, which may incur some performance loss.

#### getLocalBottom() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getLocalBottom data-toc-label='getLocalBottom' }

Returns the highest Y value of this node's bounding box (in the local coordinate frame).

NOTE: This may require computation of this node's subtree bounds, which may incur some performance loss.

#### getLocalLeftTop() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #getLocalLeftTop data-toc-label='getLocalLeftTop' }

Returns the upper-left corner of this node's localBounds.

#### getLocalCenterTop() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #getLocalCenterTop data-toc-label='getLocalCenterTop' }

Returns the center-top location of this node's localBounds.

#### getLocalRightTop() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #getLocalRightTop data-toc-label='getLocalRightTop' }

Returns the upper-right corner of this node's localBounds.

#### getLocalLeftCenter() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #getLocalLeftCenter data-toc-label='getLocalLeftCenter' }

Returns the center-left corner of this node's localBounds.

#### getLocalCenter() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #getLocalCenter data-toc-label='getLocalCenter' }

Returns the center of this node's localBounds.

#### getLocalRightCenter() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #getLocalRightCenter data-toc-label='getLocalRightCenter' }

Returns the center-right of this node's localBounds.

#### getLocalLeftBottom() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #getLocalLeftBottom data-toc-label='getLocalLeftBottom' }

Returns the lower-left corner of this node's localBounds.

#### getLocalCenterBottom() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #getLocalCenterBottom data-toc-label='getLocalCenterBottom' }

Returns the center-bottom of this node's localBounds.

#### getLocalRightBottom() : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #getLocalRightBottom data-toc-label='getLocalRightBottom' }

Returns the lower-right corner of this node's localBounds.

#### getId() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getId data-toc-label='getId' }

Returns the unique integral ID for this node.

#### setVisibleProperty( newTarget : <span style="font-weight: 400; opacity: 80%;">TReadOnlyProperty&lt;boolean&gt; | null</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setVisibleProperty data-toc-label='setVisibleProperty' }
...
#### getVisibleProperty() : <span style="font-weight: 400; opacity: 80%;">TProperty&lt;boolean&gt;</span> {: #getVisibleProperty data-toc-label='getVisibleProperty' }
...
#### setVisible( visible : <span style="font-weight: 400; opacity: 80%;">boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setVisible data-toc-label='setVisible' }
...
#### setPhetioVisiblePropertyInstrumented( phetioVisiblePropertyInstrumented : <span style="font-weight: 400; opacity: 80%;">boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setPhetioVisiblePropertyInstrumented data-toc-label='setPhetioVisiblePropertyInstrumented' }

Use this to automatically create a forwarded, PhET-iO instrumented visibleProperty internal to Node.

#### getPhetioVisiblePropertyInstrumented() : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #getPhetioVisiblePropertyInstrumented data-toc-label='getPhetioVisiblePropertyInstrumented' }

#### swapVisibility( otherNode : <span style="font-weight: 400; opacity: 80%;">Node</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #swapVisibility data-toc-label='swapVisibility' }
...
#### setOpacity( opacity : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #setOpacity data-toc-label='setOpacity' }
...
#### setDisabledOpacity( disabledOpacity : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setDisabledOpacity data-toc-label='setDisabledOpacity' }
...
#### getDisabledOpacity() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getDisabledOpacity data-toc-label='getDisabledOpacity' }

Returns the disabledOpacity of this node.

#### getEffectiveOpacity() : <span style="font-weight: 400; opacity: 80%;">number</span> {: #getEffectiveOpacity data-toc-label='getEffectiveOpacity' }

Returns the opacity actually applied to the node.

#### setFilters( filters : <span style="font-weight: 400; opacity: 80%;">Filter[]</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #setFilters data-toc-label='setFilters' }
...
#### getFilters() : <span style="font-weight: 400; opacity: 80%;">Filter[]</span> {: #getFilters data-toc-label='getFilters' }

Returns the non-opacity filters for this Node.

#### setPickableProperty( newTarget : <span style="font-weight: 400; opacity: 80%;">TReadOnlyProperty&lt;boolean | null&gt; | null</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setPickableProperty data-toc-label='setPickableProperty' }
...
#### getPickableProperty() : <span style="font-weight: 400; opacity: 80%;">TProperty&lt;boolean | null&gt;</span> {: #getPickableProperty data-toc-label='getPickableProperty' }
...
#### setPickable( pickable : <span style="font-weight: 400; opacity: 80%;">boolean | null</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setPickable data-toc-label='setPickable' }
...
#### isPickable() : <span style="font-weight: 400; opacity: 80%;">boolean | null</span> {: #isPickable data-toc-label='isPickable' }

Returns the pickability of this node.

#### setEnabledProperty( newTarget : <span style="font-weight: 400; opacity: 80%;">TReadOnlyProperty&lt;boolean&gt; | null</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setEnabledProperty data-toc-label='setEnabledProperty' }
...
#### getEnabledProperty() : <span style="font-weight: 400; opacity: 80%;">TProperty&lt;boolean&gt;</span> {: #getEnabledProperty data-toc-label='getEnabledProperty' }
...
#### setPhetioEnabledPropertyInstrumented( phetioEnabledPropertyInstrumented : <span style="font-weight: 400; opacity: 80%;">boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setPhetioEnabledPropertyInstrumented data-toc-label='setPhetioEnabledPropertyInstrumented' }
...
#### getPhetioEnabledPropertyInstrumented() : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #getPhetioEnabledPropertyInstrumented data-toc-label='getPhetioEnabledPropertyInstrumented' }

#### setEnabled( enabled : <span style="font-weight: 400; opacity: 80%;">boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setEnabled data-toc-label='setEnabled' }
...
#### getInputEnabledProperty() : <span style="font-weight: 400; opacity: 80%;">TProperty&lt;boolean&gt;</span> {: #getInputEnabledProperty data-toc-label='getInputEnabledProperty' }
...
#### setPhetioInputEnabledPropertyInstrumented( phetioInputEnabledPropertyInstrumented : <span style="font-weight: 400; opacity: 80%;">boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setPhetioInputEnabledPropertyInstrumented data-toc-label='setPhetioInputEnabledPropertyInstrumented' }
...
#### getPhetioInputEnabledPropertyInstrumented() : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #getPhetioInputEnabledPropertyInstrumented data-toc-label='getPhetioInputEnabledPropertyInstrumented' }

#### setInputEnabled( inputEnabled : <span style="font-weight: 400; opacity: 80%;">boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #setInputEnabled data-toc-label='setInputEnabled' }
...
#### isInputEnabled() : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #isInputEnabled data-toc-label='isInputEnabled' }

Returns whether input is enabled for this Node and its subtree. See setInputEnabled for more documentation.

#### setInputListeners( inputListeners : <span style="font-weight: 400; opacity: 80%;">TInputListener[]</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #setInputListeners data-toc-label='setInputListeners' }
...
#### getInputListeners() : <span style="font-weight: 400; opacity: 80%;">TInputListener[]</span> {: #getInputListeners data-toc-label='getInputListeners' }

Returns a copy of all of our input listeners.

#### setCursor( cursor : <span style="font-weight: 400; opacity: 80%;">string | null</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #setCursor data-toc-label='setCursor' }
...
#### getCursor() : <span style="font-weight: 400; opacity: 80%;">string | null</span> {: #getCursor data-toc-label='getCursor' }
...
#### getMouseArea() : <span style="font-weight: 400; opacity: 80%;">Shape | Bounds2 | null</span> {: #getMouseArea data-toc-label='getMouseArea' }
...
#### getTouchArea() : <span style="font-weight: 400; opacity: 80%;">Shape | Bounds2 | null</span> {: #getTouchArea data-toc-label='getTouchArea' }

Returns the hit-tested touch area for this node.

#### setClipArea( shape : <span style="font-weight: 400; opacity: 80%;">Shape | null</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #setClipArea data-toc-label='setClipArea' }
...
#### getClipArea() : <span style="font-weight: 400; opacity: 80%;">Shape | null</span> {: #getClipArea data-toc-label='getClipArea' }

Returns the clipped area for this node.

#### hasClipArea() : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #hasClipArea data-toc-label='hasClipArea' }

Returns whether this Node has a clip area.

#### setRendererBitmask( bitmask : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #setRendererBitmask data-toc-label='setRendererBitmask' }
...
#### setRenderer( renderer : <span style="font-weight: 400; opacity: 80%;">RendererType</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #setRenderer data-toc-label='setRenderer' }
...
#### getRenderer() : <span style="font-weight: 400; opacity: 80%;">RendererType</span> {: #getRenderer data-toc-label='getRenderer' }

Returns the preferred renderer (if any) of this node, as a string.

#### setLayerSplit( split : <span style="font-weight: 400; opacity: 80%;">boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #setLayerSplit data-toc-label='setLayerSplit' }
...
#### isLayerSplit() : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #isLayerSplit data-toc-label='isLayerSplit' }

Returns whether the layerSplit performance flag is set.

#### setUsesOpacity( usesOpacity : <span style="font-weight: 400; opacity: 80%;">boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #setUsesOpacity data-toc-label='setUsesOpacity' }
...
#### getUsesOpacity() : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #getUsesOpacity data-toc-label='getUsesOpacity' }

Returns whether the usesOpacity performance flag is set.

#### setCSSTransform( cssTransform : <span style="font-weight: 400; opacity: 80%;">boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #setCSSTransform data-toc-label='setCSSTransform' }
...
#### isCSSTransformed() : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #isCSSTransformed data-toc-label='isCSSTransformed' }

Returns whether the cssTransform performance flag is set.

#### setExcludeInvisible( excludeInvisible : <span style="font-weight: 400; opacity: 80%;">boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #setExcludeInvisible data-toc-label='setExcludeInvisible' }
...
#### isExcludeInvisible() : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #isExcludeInvisible data-toc-label='isExcludeInvisible' }
...
#### isExcludeInvisibleChildrenFromBounds() : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #isExcludeInvisibleChildrenFromBounds data-toc-label='isExcludeInvisibleChildrenFromBounds' }
...
#### setInterruptSubtreeOnInvisible( interruptSubtreeOnInvisible : <span style="font-weight: 400; opacity: 80%;">boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #setInterruptSubtreeOnInvisible data-toc-label='setInterruptSubtreeOnInvisible' }
...
#### isInterruptSubtreeOnInvisible() : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #isInterruptSubtreeOnInvisible data-toc-label='isInterruptSubtreeOnInvisible' }

Returns whether the interruptSubtreeOnInvisible flag is set, see
setInterruptSubtreeOnInvisible() for documentation.

#### setLayoutOptions( layoutOptions : <span style="font-weight: 400; opacity: 80%;">TLayoutOptions | null</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #setLayoutOptions data-toc-label='setLayoutOptions' }

Sets options that are provided to layout managers in order to customize positioning of this node.

#### getLayoutOptions() : <span style="font-weight: 400; opacity: 80%;">TLayoutOptions | null</span> {: #getLayoutOptions data-toc-label='getLayoutOptions' }

#### mutateLayoutOptions( layoutOptions? : <span style="font-weight: 400; opacity: 80%;">TLayoutOptions</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #mutateLayoutOptions data-toc-label='mutateLayoutOptions' }

#### setPreventFit( preventFit : <span style="font-weight: 400; opacity: 80%;">boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #setPreventFit data-toc-label='setPreventFit' }

Sets the preventFit performance flag.

#### isPreventFit() : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #isPreventFit data-toc-label='isPreventFit' }

Returns whether the preventFit performance flag is set.

#### setWebGLScale( webglScale : <span style="font-weight: 400; opacity: 80%;">number | null</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #setWebGLScale data-toc-label='setWebGLScale' }

Sets whether there is a custom WebGL scale applied to the Canvas, and if so what scale.

#### getWebGLScale() : <span style="font-weight: 400; opacity: 80%;">number | null</span> {: #getWebGLScale data-toc-label='getWebGLScale' }

Returns the value of the webglScale performance flag.

#### getUniqueTrail( predicate? : <span style="font-weight: 400; opacity: 80%;">( node: Node ) =&gt; boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">Trail</span> {: #getUniqueTrail data-toc-label='getUniqueTrail' }
...
#### getUniqueTrailTo( rootNode : <span style="font-weight: 400; opacity: 80%;">Node</span> ) : <span style="font-weight: 400; opacity: 80%;">Trail</span> {: #getUniqueTrailTo data-toc-label='getUniqueTrailTo' }
...
#### getTrails( predicate? : <span style="font-weight: 400; opacity: 80%;">( node: Node ) =&gt; boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">Trail[]</span> {: #getTrails data-toc-label='getTrails' }
...
#### getTrailsTo( rootNode : <span style="font-weight: 400; opacity: 80%;">Node</span> ) : <span style="font-weight: 400; opacity: 80%;">Trail[]</span> {: #getTrailsTo data-toc-label='getTrailsTo' }

Returns an array of all Trails rooted at rootNode and end at this node.

#### getLeafTrails( predicate? : <span style="font-weight: 400; opacity: 80%;">( node: Node ) =&gt; boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">Trail[]</span> {: #getLeafTrails data-toc-label='getLeafTrails' }
...
#### getLeafTrailsTo( leafNode : <span style="font-weight: 400; opacity: 80%;">Node</span> ) : <span style="font-weight: 400; opacity: 80%;">Trail[]</span> {: #getLeafTrailsTo data-toc-label='getLeafTrailsTo' }

Returns an array of all Trails rooted at this Node and end with leafNode.

#### getUniqueLeafTrail( predicate? : <span style="font-weight: 400; opacity: 80%;">( node: Node ) =&gt; boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">Trail</span> {: #getUniqueLeafTrail data-toc-label='getUniqueLeafTrail' }
...
#### getUniqueLeafTrailTo( leafNode : <span style="font-weight: 400; opacity: 80%;">Node</span> ) : <span style="font-weight: 400; opacity: 80%;">Trail</span> {: #getUniqueLeafTrailTo data-toc-label='getUniqueLeafTrailTo' }
...
#### getConnectedNodes() : <span style="font-weight: 400; opacity: 80%;">Node[]</span> {: #getConnectedNodes data-toc-label='getConnectedNodes' }

Returns all nodes in the connected component, returned in an arbitrary order, including nodes that are ancestors
of this node.

#### getSubtreeNodes() : <span style="font-weight: 400; opacity: 80%;">Node[]</span> {: #getSubtreeNodes data-toc-label='getSubtreeNodes' }
...
#### getTopologicallySortedNodes() : <span style="font-weight: 400; opacity: 80%;">Node[]</span> {: #getTopologicallySortedNodes data-toc-label='getTopologicallySortedNodes' }

Returns all nodes that are connected to this node, sorted in topological order.

#### canAddChild( child : <span style="font-weight: 400; opacity: 80%;">Node</span> ) : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #canAddChild data-toc-label='canAddChild' }
...
#### renderToCanvasSelf( wrapper : <span style="font-weight: 400; opacity: 80%;">CanvasContextWrapper</span>, matrix : <span style="font-weight: 400; opacity: 80%;">Matrix3</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #renderToCanvasSelf data-toc-label='renderToCanvasSelf' }
...
#### renderToCanvasSubtree( wrapper : <span style="font-weight: 400; opacity: 80%;">CanvasContextWrapper</span>, matrix? : <span style="font-weight: 400; opacity: 80%;">Matrix3</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #renderToCanvasSubtree data-toc-label='renderToCanvasSubtree' }
...
#### renderToCanvas( canvas : <span style="font-weight: 400; opacity: 80%;">HTMLCanvasElement</span>, context : <span style="font-weight: 400; opacity: 80%;">CanvasRenderingContext2D</span>, callback? : <span style="font-weight: 400; opacity: 80%;">() =&gt; void</span>, backgroundColor? : <span style="font-weight: 400; opacity: 80%;">string</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #renderToCanvas data-toc-label='renderToCanvas' }

@deprecated
Render this Node to the Canvas (clearing it first)

#### toCanvas( callback : <span style="font-weight: 400; opacity: 80%;">( canvas: HTMLCanvasElement, x: number, y: number, width: number, height: number ) =&gt; void</span>, x? : <span style="font-weight: 400; opacity: 80%;">number</span>, y? : <span style="font-weight: 400; opacity: 80%;">number</span>, width? : <span style="font-weight: 400; opacity: 80%;">number</span>, height? : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #toCanvas data-toc-label='toCanvas' }
...
#### toDataURL( callback : <span style="font-weight: 400; opacity: 80%;">( dataURI: string, x: number, y: number, width: number, height: number ) =&gt; void</span>, x? : <span style="font-weight: 400; opacity: 80%;">number</span>, y? : <span style="font-weight: 400; opacity: 80%;">number</span>, width? : <span style="font-weight: 400; opacity: 80%;">number</span>, height? : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #toDataURL data-toc-label='toDataURL' }
...
#### toImage( callback : <span style="font-weight: 400; opacity: 80%;">( image: HTMLImageElement, x: number, y: number ) =&gt; void</span>, x? : <span style="font-weight: 400; opacity: 80%;">number</span>, y? : <span style="font-weight: 400; opacity: 80%;">number</span>, width? : <span style="font-weight: 400; opacity: 80%;">number</span>, height? : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #toImage data-toc-label='toImage' }
...
#### toImageNodeAsynchronous( callback : <span style="font-weight: 400; opacity: 80%;">( image: Node ) =&gt; void</span>, x? : <span style="font-weight: 400; opacity: 80%;">number</span>, y? : <span style="font-weight: 400; opacity: 80%;">number</span>, width? : <span style="font-weight: 400; opacity: 80%;">number</span>, height? : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #toImageNodeAsynchronous data-toc-label='toImageNodeAsynchronous' }
...
#### toCanvasNodeSynchronous( x? : <span style="font-weight: 400; opacity: 80%;">number</span>, y? : <span style="font-weight: 400; opacity: 80%;">number</span>, width? : <span style="font-weight: 400; opacity: 80%;">number</span>, height? : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Node</span> {: #toCanvasNodeSynchronous data-toc-label='toCanvasNodeSynchronous' }
...
#### toDataURLImageSynchronous( x? : <span style="font-weight: 400; opacity: 80%;">number</span>, y? : <span style="font-weight: 400; opacity: 80%;">number</span>, width? : <span style="font-weight: 400; opacity: 80%;">number</span>, height? : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Image</span> {: #toDataURLImageSynchronous data-toc-label='toDataURLImageSynchronous' }
...
#### toDataURLNodeSynchronous( x? : <span style="font-weight: 400; opacity: 80%;">number</span>, y? : <span style="font-weight: 400; opacity: 80%;">number</span>, width? : <span style="font-weight: 400; opacity: 80%;">number</span>, height? : <span style="font-weight: 400; opacity: 80%;">number</span> ) : <span style="font-weight: 400; opacity: 80%;">Node</span> {: #toDataURLNodeSynchronous data-toc-label='toDataURLNodeSynchronous' }
...
#### rasterized( providedOptions? : <span style="font-weight: 400; opacity: 80%;">RasterizedOptions</span> ) : <span style="font-weight: 400; opacity: 80%;">Node</span> {: #rasterized data-toc-label='rasterized' }
...
#### wasVisuallyDisplayed( display? : <span style="font-weight: 400; opacity: 80%;">Display</span> ) : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #wasVisuallyDisplayed data-toc-label='wasVisuallyDisplayed' }
...
#### getConnectedDisplays() : <span style="font-weight: 400; opacity: 80%;">Display[]</span> {: #getConnectedDisplays data-toc-label='getConnectedDisplays' }
...
#### localToParentPoint( point : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #localToParentPoint data-toc-label='localToParentPoint' }

Returns a point transformed from our local coordinate frame into our parent coordinate frame. Applies our node's
transform to it.

#### localToParentBounds( bounds : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #localToParentBounds data-toc-label='localToParentBounds' }
...
#### parentToLocalPoint( point : <span style="font-weight: 400; opacity: 80%;">Vector2</span> ) : <span style="font-weight: 400; opacity: 80%;">Vector2</span> {: #parentToLocalPoint data-toc-label='parentToLocalPoint' }
...
#### parentToLocalBounds( bounds : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #parentToLocalBounds data-toc-label='parentToLocalBounds' }

Returns bounds transformed from our parent coordinate frame into our local coordinate frame. If it includes a
rotation, the resulting bounding box will include every point that could have been in the original bounding box
(and it can be expanded).

#### transformBoundsFromLocalToParent( bounds : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #transformBoundsFromLocalToParent data-toc-label='transformBoundsFromLocalToParent' }
...
#### transformBoundsFromParentToLocal( bounds : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #transformBoundsFromParentToLocal data-toc-label='transformBoundsFromParentToLocal' }
...
#### getLocalToGlobalMatrix() : <span style="font-weight: 400; opacity: 80%;">Matrix3</span> {: #getLocalToGlobalMatrix data-toc-label='getLocalToGlobalMatrix' }
...
#### getUniqueTransform() : <span style="font-weight: 400; opacity: 80%;">Transform3</span> {: #getUniqueTransform data-toc-label='getUniqueTransform' }
...
#### getGlobalToLocalMatrix() : <span style="font-weight: 400; opacity: 80%;">Matrix3</span> {: #getGlobalToLocalMatrix data-toc-label='getGlobalToLocalMatrix' }
...
#### getGlobalBounds() : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #getGlobalBounds data-toc-label='getGlobalBounds' }
...
#### boundsOf( node : <span style="font-weight: 400; opacity: 80%;">Node</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #boundsOf data-toc-label='boundsOf' }
...
#### boundsTo( node : <span style="font-weight: 400; opacity: 80%;">Node</span> ) : <span style="font-weight: 400; opacity: 80%;">Bounds2</span> {: #boundsTo data-toc-label='boundsTo' }
...
#### mutate( options? : <span style="font-weight: 400; opacity: 80%;">NodeOptions</span> ) : <span style="font-weight: 400; opacity: 80%;">this</span> {: #mutate data-toc-label='mutate' }
...
#### initializePhetioObject( baseOptions : <span style="font-weight: 400; opacity: 80%;">Partial&lt;PhetioObjectOptions&gt;</span>, config : <span style="font-weight: 400; opacity: 80%;">NodeOptions</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #initializePhetioObject data-toc-label='initializePhetioObject' }

(protected)

#### setVoicingVisible( visible : <span style="font-weight: 400; opacity: 80%;">boolean</span> ) : <span style="font-weight: 400; opacity: 80%;">void</span> {: #setVoicingVisible data-toc-label='setVoicingVisible' }
...
#### isVoicingVisible() : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #isVoicingVisible data-toc-label='isVoicingVisible' }
...
#### inspect() : <span style="font-weight: 400; opacity: 80%;">void</span> {: #inspect data-toc-label='inspect' }
...
#### disposeSubtree() : <span style="font-weight: 400; opacity: 80%;">void</span> {: #disposeSubtree data-toc-label='disposeSubtree' }
...
#### opacityProperty : <span style="font-weight: 400; opacity: 80%;">TinyProperty&lt;number&gt;</span> {: #opacityProperty data-toc-label='opacityProperty' }
...
#### disabledOpacityProperty : <span style="font-weight: 400; opacity: 80%;">TinyProperty&lt;number&gt;</span> {: #disabledOpacityProperty data-toc-label='disabledOpacityProperty' }
...
#### clipAreaProperty : <span style="font-weight: 400; opacity: 80%;">TinyProperty&lt;Shape | null&gt;</span> {: #clipAreaProperty data-toc-label='clipAreaProperty' }
...
#### voicingVisibleProperty : <span style="font-weight: 400; opacity: 80%;">TinyProperty&lt;boolean&gt;</span> {: #voicingVisibleProperty data-toc-label='voicingVisibleProperty' }
...
#### boundsProperty : <span style="font-weight: 400; opacity: 80%;">TinyStaticProperty&lt;Bounds2&gt;</span> {: #boundsProperty data-toc-label='boundsProperty' }
...
#### localBoundsProperty : <span style="font-weight: 400; opacity: 80%;">TinyStaticProperty&lt;Bounds2&gt;</span> {: #localBoundsProperty data-toc-label='localBoundsProperty' }
...
#### childBoundsProperty : <span style="font-weight: 400; opacity: 80%;">TinyStaticProperty&lt;Bounds2&gt;</span> {: #childBoundsProperty data-toc-label='childBoundsProperty' }
...
#### selfBoundsProperty : <span style="font-weight: 400; opacity: 80%;">TinyStaticProperty&lt;Bounds2&gt;</span> {: #selfBoundsProperty data-toc-label='selfBoundsProperty' }
...
#### childrenChangedEmitter : <span style="font-weight: 400; opacity: 80%;">TEmitter</span> {: #childrenChangedEmitter data-toc-label='childrenChangedEmitter' }
...
#### childInsertedEmitter : <span style="font-weight: 400; opacity: 80%;">TEmitter&lt;[ node: Node, indexOfChild: number ]&gt;</span> {: #childInsertedEmitter data-toc-label='childInsertedEmitter' }

(readonly)

For every single added child Node, emits with {Node} Node, {number} indexOfChild

#### childRemovedEmitter : <span style="font-weight: 400; opacity: 80%;">TEmitter&lt;[ node: Node, indexOfChild: number ]&gt;</span> {: #childRemovedEmitter data-toc-label='childRemovedEmitter' }

(readonly)

For every single removed child Node, emits with {Node} Node, {number} indexOfChild

#### childrenReorderedEmitter : <span style="font-weight: 400; opacity: 80%;">TEmitter&lt;[ minChangedIndex: number, maxChangedIndex: number ]&gt;</span> {: #childrenReorderedEmitter data-toc-label='childrenReorderedEmitter' }

(readonly)

Provides a given range that may be affected by the reordering

#### parentAddedEmitter : <span style="font-weight: 400; opacity: 80%;">TEmitter&lt;[ node: Node ]&gt;</span> {: #parentAddedEmitter data-toc-label='parentAddedEmitter' }

(readonly)

Fired whenever a parent is added

#### parentRemovedEmitter : <span style="font-weight: 400; opacity: 80%;">TEmitter&lt;[ node: Node ]&gt;</span> {: #parentRemovedEmitter data-toc-label='parentRemovedEmitter' }

(readonly)

Fired whenever a parent is removed

#### transformEmitter : <span style="font-weight: 400; opacity: 80%;">TEmitter</span> {: #transformEmitter data-toc-label='transformEmitter' }
...
#### instanceRefreshEmitter : <span style="font-weight: 400; opacity: 80%;">TEmitter</span> {: #instanceRefreshEmitter data-toc-label='instanceRefreshEmitter' }
...
#### rendererSummaryRefreshEmitter : <span style="font-weight: 400; opacity: 80%;">TEmitter</span> {: #rendererSummaryRefreshEmitter data-toc-label='rendererSummaryRefreshEmitter' }
...
#### filterChangeEmitter : <span style="font-weight: 400; opacity: 80%;">TEmitter</span> {: #filterChangeEmitter data-toc-label='filterChangeEmitter' }

(readonly)

Emitted to when we change filters (either opacity or generalized filters)

#### changedInstanceEmitter : <span style="font-weight: 400; opacity: 80%;">TEmitter&lt;[ instance: Instance, added: boolean ]&gt;</span> {: #changedInstanceEmitter data-toc-label='changedInstanceEmitter' }
...
#### rootedDisplayChangedEmitter : <span style="font-weight: 400; opacity: 80%;">TEmitter&lt;[ display: Display ]&gt;</span> {: #rootedDisplayChangedEmitter data-toc-label='rootedDisplayChangedEmitter' }
...
#### layoutOptionsChangedEmitter : <span style="font-weight: 400; opacity: 80%;">TEmitter</span> {: #layoutOptionsChangedEmitter data-toc-label='layoutOptionsChangedEmitter' }
...
#### defaultTrailPredicate( node : <span style="font-weight: 400; opacity: 80%;">Node</span> ) : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #defaultTrailPredicate data-toc-label='defaultTrailPredicate' }

A default for getTrails() searches, returns whether the Node has no parents.

#### defaultLeafTrailPredicate( node : <span style="font-weight: 400; opacity: 80%;">Node</span> ) : <span style="font-weight: 400; opacity: 80%;">boolean</span> {: #defaultLeafTrailPredicate data-toc-label='defaultLeafTrailPredicate' }
...
#### NodeIO : <span style="font-weight: 400; opacity: 80%;">IOType</span> {: #NodeIO data-toc-label='NodeIO' }
