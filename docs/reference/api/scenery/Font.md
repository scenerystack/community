...
!!! warning "Under Construction"
    ...
    [https://github.com/phetsims/scenery/blob/main/js/util/Font.ts](https://github.com/phetsims/scenery/blob/main/js/util/Font.ts) for the most up-to-date information.
