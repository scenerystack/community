...
!!! warning "Under Construction"
    ...
    [https://github.com/phetsims/scenery/blob/main/js/layout/nodes/GridBox.ts](https://github.com/phetsims/scenery/blob/main/js/layout/nodes/GridBox.ts) for the most up-to-date information.

## Overview

A grid-based layout container.

See https://scenerystack.org/learn/scenery-layout/#GridBox for details

GridBox-only options:
  - rows (see https://scenerystack.org/learn/scenery-layout/#GridBox-rows)
  - columns (see https://scenerystack.org/learn/scenery-layout/#GridBox-columns)
  - autoRows (see https://scenerystack.org/learn/scenery-layout/#GridBox-autoLines)
  - autoColumns (see https://scenerystack.org/learn/scenery-layout/#GridBox-autoLines)
  - resize (see https://scenerystack.org/learn/scenery-layout/#GridBox-resize)
  - spacing (see https://scenerystack.org/learn/scenery-layout/#GridBox-spacing)
  - xSpacing (see https://scenerystack.org/learn/scenery-layout/#GridBox-spacing)
  - ySpacing (see https://scenerystack.org/learn/scenery-layout/#GridBox-spacing)
...
GridBox and layoutOptions options (can be set either in the GridBox itself, or within its child nodes' layoutOptions):
  - xAlign (see https://scenerystack.org/learn/scenery-layout/#GridBox-align)
  - yAlign (see https://scenerystack.org/learn/scenery-layout/#GridBox-align)
  - stretch (see https://scenerystack.org/learn/scenery-layout/#GridBox-stretch)
  - xStretch (see https://scenerystack.org/learn/scenery-layout/#GridBox-stretch)
  - yStretch (see https://scenerystack.org/learn/scenery-layout/#GridBox-stretch)
  - grow (see https://scenerystack.org/learn/scenery-layout/#GridBox-grow)
  - xGrow (see https://scenerystack.org/learn/scenery-layout/#GridBox-grow)
  - yGrow (see https://scenerystack.org/learn/scenery-layout/#GridBox-grow)
  - margin (see https://scenerystack.org/learn/scenery-layout/#GridBox-margins)
  - xMargin (see https://scenerystack.org/learn/scenery-layout/#GridBox-margins)
  - yMargin (see https://scenerystack.org/learn/scenery-layout/#GridBox-margins)
  - leftMargin (see https://scenerystack.org/learn/scenery-layout/#GridBox-margins)
  - rightMargin (see https://scenerystack.org/learn/scenery-layout/#GridBox-margins)
  - topMargin (see https://scenerystack.org/learn/scenery-layout/#GridBox-margins)
  - bottomMargin (see https://scenerystack.org/learn/scenery-layout/#GridBox-margins)
  - minContentWidth (see https://scenerystack.org/learn/scenery-layout/#GridBox-minContent)
  - minContentHeight (see https://scenerystack.org/learn/scenery-layout/#GridBox-minContent)
  - maxContentWidth (see https://scenerystack.org/learn/scenery-layout/#GridBox-maxContent)
  - maxContentHeight (see https://scenerystack.org/learn/scenery-layout/#GridBox-maxContent)

layoutOptions-only options (can only be set within the child nodes' layoutOptions, NOT available on GridBox):
  - x (see https://scenerystack.org/learn/scenery-layout/#GridBox-layoutOptions-location)
  - y (see https://scenerystack.org/learn/scenery-layout/#GridBox-layoutOptions-location)
