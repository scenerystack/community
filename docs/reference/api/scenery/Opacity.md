...
!!! warning "Under Construction"
    ...
    [https://github.com/phetsims/scenery/blob/main/js/filters/Opacity.ts](https://github.com/phetsims/scenery/blob/main/js/filters/Opacity.ts) for the most up-to-date information.
...
#### new Opacity( amount : <span style="font-weight: 400;"><span style="color: hsla(calc(var(--md-hue) + 180deg),80%,40%,1);">number</span></span> ) {: #Opacity-constructor data-toc-label='new Opacity' }
