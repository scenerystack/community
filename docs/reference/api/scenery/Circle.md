...
!!! warning "Under Construction"
    ...
    [https://github.com/phetsims/scenery/blob/main/js/nodes/Circle.ts](https://github.com/phetsims/scenery/blob/main/js/nodes/Circle.ts) for the most up-to-date information.
